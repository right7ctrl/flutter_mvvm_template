...
class NavigationService {
  ...
  void config({
    ...
    @Deprecated('Prefer to use the defaultTransitionStyle instead of using this property. This will be removed in the next major version update for stacked.') String? defaultTransition,
  }) {
    G.Get.config(enableLog: enableLog, defaultPopGesture: defaultPopGesture, defaultOpaqueRoute: defaultOpaqueRoute, defaultDurationTransition: defaultDurationTransition, defaultGlobalState: defaultGlobalState, defaultTransition: defaultTransitionStyle);
  }
  ...
  Future<T?>? navigateTo<T>(
    ...
    return G.Get.toNamed<T?>(
      routeName,
      arguments: transition != null ? {'arguments': arguments, 'transition': transition} : arguments,
      id: id,
      preventDuplicates: preventDuplicates,
  ...
  ///
  /// [id] is for when you are using nested navigation, as explained in documentation.
  Future<T?>? clearTillFirstAndShowView<T>(Widget view, {dynamic arguments, int? id}) {
    _clearBackstackTillFirst();
  ...
  ///
  /// [id] is for when you are using nested navigation, as explained in documentation.
  Future<T?>? pushNamedAndRemoveUntil<T>(String routeName, {RoutePredicate? predicate, dynamic arguments, int? id}) {
    return G.Get.offAllNamed<T?>(
      routeName,
      predicate: predicate,
      arguments: arguments,
